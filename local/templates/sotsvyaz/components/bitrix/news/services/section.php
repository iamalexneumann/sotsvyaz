        ...
        <div class="row">
            ...
            <div class="first-screen__media col-lg-4">
                <figure class="first-screen__figure">
                    <img src="<?= $arResult['SECTION_UFS']['PICTURE_LQIP']['SRC']; ?>"
                         data-src="<?= $arResult['SECTION_UFS']['PICTURE']['SRC']; ?>"
                         class="first-screen__img lazyload blur-up"
                         alt="<?= $arResult['SECTION_UFS']['UF_TITLE']?: $arResult['SECTION_UFS']['NAME']; ?>"
                         width="<?= $arResult['SECTION_UFS']['PICTURE']['WIDTH']; ?>"
                         height="<?= $arResult['SECTION_UFS']['PICTURE']['HEIGHT']; ?>">
                </figure>
            </div>
        </div>
    </div>
