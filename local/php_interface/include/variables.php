...
$siteparam_scripts_head = Option::get('askaron.settings', 'UF_SECTION_HEAD', '');
$siteparam_scripts_body_before = Option::get('askaron.settings', 'UF_SECTION_BODY_BEFORE', '');
$siteparam_scripts_body_after = Option::get('askaron.settings', 'UF_SECTION_BODY_AFTER', '');
